...
public class Thum1 {
	...
	public static void main(String[] args) {
		...
		int index = originalFileName.lastIndexOf("."); // . 뒤에 있는 내용
	...
	/**
	 * 이미지 손상 없이 250 x 150 크기의 썸네일 만들기
	 * 실행하면 자바 프로젝트 안에 THUMB_cat.jpg 생김
	 * @throws Exception 
	 */
	
	private static void makeThumbnail(String filePath, String fileName, String fileExt) throws Exception {
